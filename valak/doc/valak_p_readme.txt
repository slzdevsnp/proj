...
#copies predlded files  2015, 2016 into my bucket valak/flights/raw
 $ ingest_from_crsbucket.sh  valak   

2. alternative  ingest from the original source and carry cleanup steps
