...
alldays = LOAD 'gs://brd_valak/flights/trainday.csv' 
...
ALLFLIGHTS = 
   LOAD 'gs://brd_valak/flights/tzcorr/all_flights-*'
...
store result into 'gs://brd_valak/flights/pigoutput/' using PigStorage(',','-schema');
